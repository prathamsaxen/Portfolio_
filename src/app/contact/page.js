...
export default function page() {
    ...
    return (
        <div className={styles.contact}>
            ...
            {displayForm === 0 ? <ContactForm userDetails={userDetails} setUserDetails={setUserDetails} handleSubmit={handleSubmit} marginTOP={'60px'} disabled={disable} /> : <ErrorForm marginTOP={'60px'} status={status} />}
