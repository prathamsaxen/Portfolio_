        ...
        <div className={styles.main}>
            ...
            <div className={styles.mainHome}>
                <div className={styles.infoFrame}>
                    <div className={styles.leftInfoFrame}>
                        ...
                        <p className={'point'}>A front-end engineer and UI/UX designer helping startups turn their visions into a digital reality. I specialize in designing and building modern mobile and web-based apps.</p>
                        <div className={`${styles.buttonStacks} point`}>
                            <Link href=''>See my resume</Link>
            ...
            <div className={styles.contactFrame}>
                <div className={styles.contentContactFrame}>
                    ...
                    <p className='workTogatherPara'>Want to discuss an opportunity to create something great? I’m ready when you are.</p>
                </div>
