                ...
                <div className={styles.gradient}>
                    ...
                    <div className={styles.rightFooter}>
                        ...
                        <div className={styles.Links}>
                            ...
                            <Link href='https://github.com/prathamsaxen' target='_blank'>
                                Github
                            </Link>
                            <Link href='https://www.youtube.com/@Pratham-Saxena' target='_blank'>
                                Youtube
                            </Link>
                            <Link href='https://twitter.com/pratham__saxena' target='_blank'>
                                Twitter
                            </Link>
